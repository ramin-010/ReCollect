      ...
      <div className="relative z-10 w-full h-full max-w-[1400px] mx-auto px-12 flex items-end justify-between pb-3">
        ...
        <div className="flex flex-col justify-end space-y-1 ">
            ...
            <motion.h1 
                ...
                className="text-3xl lg:text-4xl font-light tracking-tight text-[hsl(var(--foreground))]/90 font-serif"
            >
                Good {greeting.split(' ')[1] || 'Day'}, <br/>
                <span className="font-bold font-sans text-[hsl(var(--foreground))]">{name}</span>
            </motion.h1>
            ...
            <motion.p 
                ...
                className="text-[hsl(var(--muted-foreground))] text-xs font-medium pl-2 mt-1 border-l-2 border-emerald-500/30"
            >
        ...
        <div className="absolute left-1/2 bottom-4 -translate-x-1/2 flex flex-col items-center select-none z-20">
            ...
            />
                 ...
                 <button
                    ...
                    className="absolute -bottom-1 -right-6 p-2 rounded-full text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-all transform hover:scale-110 active:scale-95"
        ...
        <div className="flex flex-col items-end justify-end mb-2 z-10 w-32">
             <motion.p 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2 }}
                className="text-[hsl(var(--muted-foreground))] text-xs font-medium pr-2 mt-1 border-r-2 border-emerald-500/30 text-right opacity-70"
            >
