  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 px-4 pt-3 pb-2 flex flex-col justify-between bg-[var(--surface-elevated)]">
          <div className="flex flex-col gap-3">
            {/* Title Skeleton */}
            <div className="h-6 w-3/4 rounded-md bg-[var(--hover-bg)] animate-pulse" />

            {/* Preview Content Skeleton - 3 lines with varying widths */}
            <div className="flex flex-col gap-2.5 pt-1">
              <div className="h-3 w-full rounded bg-[var(--hover-bg)]/70 animate-pulse" />
              <div className="h-3 w-[85%] rounded bg-[var(--hover-bg)]/70 animate-pulse" style={{ animationDelay: '150ms' }} />
              <div className="h-3 w-[65%] rounded bg-[var(--hover-bg)]/70 animate-pulse" style={{ animationDelay: '300ms' }} />
            </div>
          </div>
